...
const DetailsPage = () => {
  ...
  return (
   <Box>
    <Box background={`linear-gradient(rgba(0, 0, 0,.88), rgba(0, 0, 0,.88)), url(${imagePathOriginal}/${details?.
backdrop_path
})`}
        ...
        <Flex alignItems={"center"} gap="10" flexDirection={{base: "column", md: "row"}}>
          ...
          <Box>
            ...
            <Flex alignItems={"center"}>
              <CalendarIcon mr={2} color={"pink.400"} />
               <Text fontSize={"sm"}>
          ...
          <Flex alignItems={"center"} gap={"4"}>
           ...
           <Text display={{base: "none", mb: "initial" }}>
            User Score
            </Text>
            {isInWatchlist ? (
                  <Button
          ...
          >
            ...
            <Text fontSize={"medium"} mb={"3"}>{details?.overview}</Text>
            <Flex mt="6" gap="2" >
    ...
    <Container maxW={"container.xl"} pb="10">
      <Heading as="h2" fontSize={"medium"} textTransform={"uppercase"} mt="10" >
        Cast
      </Heading>
